...
<link rel="stylesheet" href="/assets/css/add-edit.css">
		<fieldset class="form-group">
			...
			{!! Form::select('insurance_id', $plans, isset($selected) ? $selected : 0, ['class' => 'form-control col-md-9']) !!}
		</fieldset>

		<fieldset class="form-group">
			{!! Form::label('request_type_id', 'Request Type:', ['class' => 'label-requests col-md-3']) !!}
			{!! Form::select('request_type_id', $types, isset($selType) ? $selType : 0, ['class' => 'form-control col-md-9']) !!}
		</fieldset>
